...
-- the metadata field "zotero-api-key" to that key:
--
--     pandoc -L pandoc-zotxt.lua -C <<EOF
--     ---
...
-- insignificant. If you use Better BibTeX for Zotero, you can add the
-- citation key it has generated by 'pinning' it.
--
...
-- Any series of *n* dollar signs will be replaced with *n* – 1 dollar
-- signs, so that you can escape them should they occur in a filename.
--
...
-- the same as giving a single item:
--
--     pandoc -L pandoc-zotxt.lua -C <<EOF
--     ---
