...
-- requires the Zotero add-ons zotxt and the BetterBibTeX for Zotero to be
-- installed.
--
-- Web API
-- -------
...
-- pairs by linefeeds. Use either the key "Citation key" or the key "Citekey"
-- to add a citation key (e.g., "Citation key: DoeTitle2020"); case is
-- insignifcant. If you use Better BibTeX for Zotero, you can add the citation
-- key it has generated by 'pinning' it.
--
...
-- field to a filename. If that filename is relative, the file is searched for
-- in the resource search path; if no file of the given name can be found, the
...
-- automatically, giving priority to bibliography files that have been already
-- defined.
--
-- Items in the bibliography file are neither updated nor deleted
-- automatically. If you need to update or delete items, delete the file as a
-- whole, so that it will be regenerated from scratch. You can also edit it
-- manually, of course.
--
-- For example:
--
